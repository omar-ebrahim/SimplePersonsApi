...
namespace People.Web
{
    public class Startup
    {
        ...
        {
            // Services
            GetTypes("People.Web.Services").ToList().ForEach(x => serviceCollection.AddScoped(x.GetInterface($"I{x.Name}"), x));
        }

        private static IEnumerable<Type> GetTypes(string assemblyName)
        {
